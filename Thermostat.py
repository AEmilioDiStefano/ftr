...
## Toggle between these two sensor variables where 
## sensors are used depending on whether you are  
## using an AHTx0 or SHT31 temperature sensor.
##
thSensorAHT = adafruit_ahtx0.AHTx0(i2c)

thSensorSHT = adafruit_sht31d.SHT31D(i2c)
...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        ##
        ## TODO: Pulse the red indicator light upon entering 
        ## the 'heat' state. 
        redLight.pulse()
    ...
    def on_exit_heat(self):
        ##
        ## TODO: Turn off the red indicator light upon exiting 
        ## the heat state.
        redLight.off()
    ...
    def on_enter_cool(self):
        ##
        ## TODO: Pulse the blue indicator light upon entering 
        ## the 'cool' state.
        blueLight.pulse()
    ...
    def on_exit_cool(self):
        ##
        ## TODO: Turn off the blue indicator light upon exiting 
        ## the 'cool' state.
        blueLight.off()
    ...
    def on_enter_off(self):
        ##
        ## TODO: Turn off all lights upon entering the off state.
        redLight.off()
        blueLight.off()
...
#33#######################################################################33#
#33#######################################################################33#
#33###   _____ _    _  ____   _____ ____  _            _______ ______  ###33#
#33###  / ____| |  | |/ __ \ / ____/ __ \| |        /\|__   __|  ____| ###33#
#33### | |    | |__| | |  | | |   | |  | | |       /  \  | |  | |__    ###33#
#33### | |    |  __  | |  | | |   | |  | | |      / /\ \ | |  |  __|   ###33#
#33### | |____| |  | | |__| | |___| |__| | |____ / ____ \| |  | |____  ###33#
#33###  \_____|_|  |_|\____/ \_____\____/|______/_/    \_\_|  |______| ###33#
#33###                                                                 ###33#
#33#######################################################################33#
#33#######################################################################33#
#          | | 
...
#33###########################################33#
#33###########################################33#
#33###   _____ _    _  ____   _____ ____   ###33#
#33###  / ____| |  | |/ __ \ / ____/ __ \  ###33#
#33### | |    | |__| | |  | | |   | |  | | ###33#
#33### | |    |  __  | |  | | |   | |  | | ###33#
#33### | |____| |  | | |__| | |___| |__| | ###33#
#33###  \_____|_|  |_|\____/ \_____\____/  ###33#
#33###                                     ###33#
#33###########################################33#
#33###########################################33#
...
#          \_/
    ...
    def updateLights(self):
        ...
        if (self.current_state.id == 'off'):
            if (self.setPoint > self.getFahrenheit()):
                self.on_enter_heat()
                self.send("cycle")
            elif (self.setPoint < self.getFahrenheit()):
                self.on_enter_cool()
                self.send("cycle")
        else:
...
#33###########################################33#
    ...
    def setupSerialOutput(self):
        ##
        ## TODO: Create an output string that will provide a single 
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            ##
            ## TODO: Setup the first line of the LCD display to incude the 
            ...
            if(altCounter < 6):
                ##
                ## TODO: Setup the second line of the LCD display to incude the 
                ...
                lcd_line_2 = str(self.current_state.id) + " Setpoint: " + str(self.setPoint)
            ...
            if((counter % 30) == 0):
                ##
                ## TODO: Send our current state information to the TemperatureServer
                ## over the Serial Port (UART). 
                # TODO: #################################################################################
...
##
## TODO: Change the state of our thermostat when 
