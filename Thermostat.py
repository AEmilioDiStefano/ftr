...
#      \ /
            ...
            if(altCounter < 6):
                ...
                line_string = 'Current temp: ' + temp_string
                line_char_array = list(line_string)            
                
                lcd_line_2 = line_char_array
    
                altCounter = altCounter + 1

            else:
                state_string = str(self.current_state.id)
                temp_string = str(self.setPoint)
                line_string = state_string + ' Setpoint: ' + temp_string
                line_char_array = list(line_string)
                ##
                ## Setup the second line of the LCD display to incude the 
