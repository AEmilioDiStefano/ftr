...
class TemperatureMachine(StateMachine):
   ...
   ##
    ...
    def run(self):
        ...
        temperatureDBThread = Thread(target=self.updateDBTemperature,)
...
class HumidityMachine(StateMachine):
   ...
   ##
    ...
    def run(self):
        ...
        humidityDBThread = Thread(target=self.updateDBHumidity,)
