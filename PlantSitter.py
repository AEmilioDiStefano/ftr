...
class HumidityMachine(StateMachine):
   ...
   ##
    ...
    ##
    ## Get the humidity in Fahrenheit
    ##
    def getFahrenheit(self):
        t = thSensor.humidity
        return (((9/5) * t) + 32)
    ...
    def processHumidityData(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                ##
                ## Setup the second line of the LCD display to incude the 
                # current humidity in degrees Fahrenheit. 
                humidity_string = str(round(tsm.getFahrenheit(), 2))
                line_string = ' Current: ' + humidity_string           
                ...
                ## Setup the second line of the LCD display to incude the 
                ## current state of the thermostat and the current 
                ## humidity setpoint in degrees Fahrenheit. 
                lcd_line_2 = line_string
            ...
            ## Update Display
            humidity_screen.updateHumidityScreen(lcd_line_1 + lcd_line_2)
...
def runTemperatureStateMachine():
    ...
    ##
    ## Change the value of the humidity setpoint when 
...
def main():
    ...
    humidity_control_thread = threading.Thread(target=runTemperatureStateMachine,)
