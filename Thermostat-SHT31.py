...
#33###########################################33#
    ...
    def setupSerialOutput(self):
        ...
        output = "State: " + self.curent_state.id + ", \nCurrent Temp: " + self.getFahrenheit() + ", \nTarget Temp: " + self.setPoint
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = "Current Temp: " + str(tsm.getFahrenheit())
                ...
                lcd_line_2 = self.curent_state.id + " Setpoint: " + self.setPoint
