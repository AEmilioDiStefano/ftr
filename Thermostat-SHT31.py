...
#          \_/
    ...
    def updateLights(self):
        ...
        if (self.current_state.id == 'off' & self.setPoint > self.getFahrenheit()):
            self.on_enter_heat()
            
        if (self.current_state.id == 'off' & self.setPoint < self.getFahrenheit()):
            self.on_enter_cool()
        
        if (self.current_state.id == 'heat' & self.setPoint < self.getFahrenheit()):
            self.on_exit_heat()
            self.on_enter_cool()

        if (self.current_state.id == 'heat' & self.current_state.id == 'cool'):
            self.on_exit_cool()
            self.on_exit_heat
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"Current temp: {temp_string}"
